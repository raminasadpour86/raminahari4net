...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/raminahari4net)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/raminahari4net
```

A live public deployment of this template is available at [https://raminahari4net.templates.workers.dev](https://raminahari4net.templates.workers.dev)
